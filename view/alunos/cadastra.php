...
<head>
    <meta charset="UTF-8">
    <title>Cadastro de Aluno - Academia FitLife</title>
    <style>
    ...
    <form action="" method="POST">
        ...
        <div class="linha">
            ...
            <div>
                ...
                <input type="date" id="data_matricula" name="data_matricula" value="<?= date('Y-m-d') ?>" required>
            </div>
        </div>
        ...
        <div class="secao">
            ...
            <div class="linha">
                ...
                <div>
                    ...
                    <input type="text" id="cidade" name="cidade" placeholder="Preenchido pelo CEP">
                </div>
            </div>

            <label for="bairro">Bairro</label>
            <input type="text" id="bairro" name="bairro" placeholder="Preenchido pelo CEP">

            <label for="rua">Rua</label>
            <input type="text" id="rua" name="rua" placeholder="Preenchido pelo CEP">
        </div>
